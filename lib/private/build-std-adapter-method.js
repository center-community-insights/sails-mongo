...
module.exports = function buildStdAdapterMethod (machineDef, WET_MACHINES, registeredDsEntries, registeredDryModels) {
  ...
  // Core runner used by both callback and promise styles.
  function run(datastoreName, s3q, done) {
  ...
  return function (datastoreName, s3q, done) {
    ...
    // Support promise-style if callback is omitted.
    if (!_.isFunction(done)) {
      return new Promise(function(resolve, reject) {
        run(datastoreName, s3q, function(err, result){
