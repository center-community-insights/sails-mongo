    ...
    var run = function (_datastoreName, _s3q, _done) {
      ...
      var ensureDatastoreRegistered = function (next) {
        ...
        var timeout = setTimeout(function () {
          timedOut = true;
          return next(new Error('Consistency violation: Timed out waiting for datastore (`'+_datastoreName+'`) to be registered.  (This usually means a model query ran before Waterline finished initialization.)'));
        }, 30000);
