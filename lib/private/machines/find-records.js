module.exports = {
  ...
  fn: function (inputs, exits) {
    ...
    var mongoSort = _.map(s3q.criteria.sort, function mapSort(s3qSortDirective) {
      ...
      assert(sortDirection === 'ASC' || sortDirection === 'DESC', 'Invalid sort direction in criteria. Expected ASC/DESC (or 1/-1), but got: '+require('util').inspect(s3qSortDirective, {depth: 5}));
