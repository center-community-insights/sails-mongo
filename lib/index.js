...
module.exports = {
  ...
  native: function (unusedDatastoreName, unusedTableName, unusedCb) {
    ...
    collection.find = function(query, options) {
      ...
      try { query = normalizeBson.deep(query); } catch (e) { /* ignore */ }
    ...
    collection.updateOne = function(filter, update, options) {
      try { filter = normalizeBson.deep(filter); } catch (e) { /* ignore */ }
      try { update = normalizeBson.deep(update); } catch (e) { /* ignore */ }
    ...
    collection.insertOne = function(doc, options) {
      try { doc = normalizeBson.deep(doc); } catch (e) { /* ignore */ }
    ...
    collection.insertMany = function(docs, options) {
      try { docs = normalizeBson.deep(docs); } catch (e) { /* ignore */ }
